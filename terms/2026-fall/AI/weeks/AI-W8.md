...
- `Week-by-Week-Narrative.md` `## Week 8 — MIDTERM EXAM WEEK` (lines 164–174)
---
...
- Review search algorithm comparison table (BFS, DFS, UCS, A*) — `Week-by-Week-Narrative.md` Wk8 Focus
