...
Lab 14 (Complex Engineering Activity) is excluded per request.

| # | Lab Session Title | Group |
|---|---|---|
| 1 | Implementing Simple Neural Network Using Perceptron | ANN / ML (Labs 1–5) |
| 2 | Developing an Artificial Neural Network (ANN) Using Perceptron | ANN / ML (Labs 1–5) |
| 3 | Applying Data Preprocessing for ANN | ANN / ML (Labs 1–5) |
| 4 | Developing ANN Using ADALINE | ANN / ML (Labs 1–5) |
| 5 | Developing ANN Using Backward Propagation | ANN / ML (Labs 1–5) |
| 6 | Applying Uninformed Searching Techniques for Problem Solving | Searching (Labs 6–7) |
| 7 | Applying Informed Searching Techniques for Problem Solving | Searching (Labs 6–7) |
| 8 | Solving CSPs by Enforcing Arc Consistency | CSP (Labs 8–9) |
| 9 | Solving CSPs Using Stochastic Local Search Techniques | CSP (Labs 8–9) |
| 10 | Developing Knowledge-Based Systems | Expert Systems (Labs 10–12) |
| 11 | Constructing Complex Rule-Based Systems | Expert Systems (Labs 10–12) |
| 12 | Practicing Data-Driven Programming in Expert Systems | Expert Systems (Labs 10–12) |
...
- [alesunaga/perceptron_logic_gates](https://github.com/alesunaga/perceptron_logic_gates) — Perceptron implementing and visualizing AND, OR, XOR gates.
...
- [BecayeSoft/Perceptron](https://github.com/BecayeSoft/Perceptron) — From-scratch Perceptron class (learning rate, iterations, weight update rule) with tutorial.
...
- [sch-notes-phase-4/tuning-neural-networks-with-normalization-lab](https://github.com/sch-notes-phase-4/tuning-neural-networks-with-normalization-lab) — Normalizing numeric features before training NN models on housing data.
- [cfteach/NNDL_2025](https://github.com/cfteach/NNDL_2025) — Course notebooks: imputation, one-hot encoding, feature scaling, train/test partition (plus perceptron/ADALINE labs).
...
- [siqi-y-sun/Neural-Network-Backpropagation-from-Scratch](https://github.com/siqi-y-sun/Neural-Network-Backpropagation-from-Scratch) — NumPy backprop solving XOR, compared against PyTorch.
...
- [TheAlgorithms/Python](https://github.com/TheAlgorithms/Python) — Huge educational algorithm collection with BFS/DFS/A* under searches/ and graphs/ (223k stars).
- [keon/algorithms](https://github.com/keon/algorithms) — Minimal well-documented Python algorithms incl. BFS/DFS and maze search.
...
- [rmssoares/8Puzzle-StateSpaceSearches](https://github.com/rmssoares/8Puzzle-StateSpaceSearches) — BFS, IDS, Greedy, and A* applied to the 8-puzzle.
- [zhijs/8puzzle](https://github.com/zhijs/8puzzle) — 8-puzzle solver in Python using BFS/DFS and A*.
...
- [ania-I/ac3-algorithm](https://github.com/ania-I/ac3-algorithm) — Focused implementation of the AC-3 arc consistency algorithm.
...
- [calcelli/Min-Conflict-nQueens](https://github.com/calcelli/Min-Conflict-nQueens) — Min-conflicts N-Queens solver (moves random queen to fewest-conflict spot).
- [duncansclarke/N-Queens](https://github.com/duncansclarke/N-Queens) — N-Queens via iterative repair + min-conflicts heuristic.
...
- [e-loue/pyke](https://github.com/e-loue/pyke) — PyKE, the Python Knowledge Engine implementing forward and backward chaining.
- [smarr/CLIPS](https://github.com/smarr/CLIPS) — Source of CLIPS, the classic C-based expert system tool.
...
- [Hale-Lee/RuleEngine](https://github.com/Hale-Lee/RuleEngine) — RETE-based rule engine with SQL/XML/DRL rule definitions, supports Drools import.
- [secbr/drools](https://github.com/secbr/drools) — Drools rules-engine integration for Spring Boot applications.
...
- [KSD-CO/rust-rule-engine](https://github.com/KSD-CO/rust-rule-engine) — Rust rule engine combining RETE with forward and backward chaining inference.
- [adeschamps/rete](https://github.com/adeschamps/rete) — Rust implementation of the RETE pattern-matching algorithm.
...
- [Python-Fuzzylogic/fuzzylogic](https://github.com/Python-Fuzzylogic/fuzzylogic) — Fuzzy logic and fuzzy inference for Python 3 with a web GUI for experimentation and code generation.
- [aresio/simpful](https://github.com/aresio/simpful) — Lightweight fuzzy logic library with natural-language rules; Mamdani and Sugeno reasoning.
- [fuzzylite/pyfuzzylite](https://github.com/fuzzylite/pyfuzzylite) — Python port of FuzzyLite control library (6 controller types, 30+ example controllers from MATLAB/Octave).
- [caigen/scikit-fuzzy-examples](https://github.com/caigen/scikit-fuzzy-examples) — Step-by-step worked examples: membership functions, defuzzification, Mamdani/Sugeno tipping implementations.
- [jdvelasq/fuzzy-expert](https://github.com/jdvelasq/fuzzy-expert) — Python package for building Mamdani fuzzy inference systems (membership functions, T-norms, certainty factors) with tutorial notebooks.
- [Guoxuan99/Washing-Machine-Fuzzy-Logic-Controller](https://github.com/Guoxuan99/Washing-Machine-Fuzzy-Logic-Controller) — University fuzzy-logic assignment: washing machine controller with 5 inputs / 5 outputs using skfuzzy.
- [unifr-fss/fuzzy-tutorial](https://github.com/unifr-fss/fuzzy-tutorial) — University tutorial notebooks covering fuzzy control systems and fuzzy clustering with scikit-fuzzy.

---

*All repositories were confirmed to exist via live web/GitHub search during compilation (2026-07-31). Lab 14 (Complex Engineering Activity) excluded per request.*
