...
A: Contiguous rectangles over class intervals, area ∝ frequency

Q: Where is a bar chart used?
A: Categorical (qualitative) data with gaps between bars
...
2. Classify: marks, gender, temperature, shoe size.
3. What are the types of frequency distributions?
4. Convert a raw dataset into a frequency table.
5. Draw a histogram from a frequency table.
6. Draw a frequency polygon.
7. When is a pie-chart better than a bar diagram?
8. What is a component bar diagram?
9. Distinguish class limits and boundaries.
10. What information is lost in grouping data?
11. Why is a histogram not drawn for categorical data?
