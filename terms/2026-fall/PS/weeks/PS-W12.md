...
- CI for mean (σ known: x̄ ± z_α/2 × σ/√n; σ unknown: x̄ ± t_α/2 × s/√n) — Q1
- CI for proportion: p̂ ± z_α/2 × √(p̂(1−p̂)/n) — Q2
...
- Definitions: `Definition-Book.md` → Confidence Interval
- Formulas: `Formula-Book.md` → Confidence Intervals (all)
...
**Sleep banking:** begin sleeping 9 h (bedtime 22:00) for 7 nights leading to finals — formula recall degrades 15–20% per lost sleep hour.
