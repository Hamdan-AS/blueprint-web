...
- Timed full-length past paper (3 h, closed book) — START with the past paper, NOT with review — `Week-by-Week-Narrative.md` Week 14
- Hypothesis testing: 4 complete problems (z, t, χ²) — `Numerical-Book.md` #59–63
- Confidence intervals: 5 problems — #64–66
- Bayes: 3 problems — #51
- Regression: 2 complete problems — #67–70
- Descriptive stats: mean, variance, skewness from raw data — #46–48
...
- Modules: M7 (★★★★★) + M4 Markov/random-processes supplement
...
**Final formula sheet** (1 page double-sided): Bayes, z/t-test, CI (mean, proportion), χ², regression (a, b, r, R²), Binomial/Poisson/Normal, Markov πP = π. Sleep 9 h (bedtime 22:00) — do NOT trade sleep for last-minute study.
