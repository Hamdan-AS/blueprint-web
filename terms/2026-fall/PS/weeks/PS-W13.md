...
- Coefficient of determination R² — Q2
- Regression line Y = a + bX; b = Σ((x−x̄)(y−ȳ))/Σ((x−x̄)²); a = ȳ − bx̄ — Q1–Q2
...
- Definitions: `Definition-Book.md` → Correlation Coefficient (r), R²
- Formulas: `Formula-Book.md` → Regression (all)
- Module: `03-Chapter-Breakdowns/08-Simple-Regression-and-Correlation.md` (M8, ★★★★☆)
