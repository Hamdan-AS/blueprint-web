...
- **No new material.** `Fear-Killer-Packs.md` `### Week 8: MIDTERM EXAM WEEK` — no pack.
- `Week-by-Week-Narrative.md` `## Week 8 — MIDTERM EXAM WEEK` (lines 141–149)
